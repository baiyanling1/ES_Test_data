...
class DB_BIZ(object):
    ...
    def insert(self, biz_code, created_time, id_card, legal_user, msisdn,name,state,update_time):
        ...
        # append = 'INSERT INTO signing_business_record (biz_code, created_time, id_card, legal_user, msisdn, name, state, update_time)  VALUES'+"("+str(biz_code)+","+"'"+created_time+"'"+","+"'"+str(id_card)+"'"+","+"'"+str(legal_user)+"'"+","+"'"+str(msisdn)+"'"+","+"'"+str(name)+"'"+","+"'"+str(state)+"'"+","+"'"+created_time+"'"+")"
        print(append)
        try:
