...
CROSS JOIN (
    ...
    UNION ALL SELECT 'APNS_PUSH_FAIL_COUNT', 150, 'IOS APNS push failed count', NULL
    ...
    UNION ALL SELECT 'ESIM_CLIENT_DOWNLOAD_ORDER_REQ_FAIL_COUNT', 225, 'Number of failed ESIMCLIENT DownloadOrder requests', NULL
    UNION ALL SELECT 'FCM_PUSH_FAIL_COUNT', 150, 'Android FCM push failed count', NULL
    UNION ALL SELECT 'QUERY_COMPANIONESIM_SUBSCRIPTION_FAIL_COUNT', 225, 'Number of failed companion eSIM subscription queries', NULL
    UNION ALL SELECT 'QUERY_COMPANIONESIM_SUBSCRIPTION_SUCC_COUNT', 900, 'Number of successful companion eSIM subscription queries', NULL
    UNION ALL SELECT 'QUERY_SOAP_FAIL_COUNT', 300, 'Number of failed SOAP queries', NULL
    UNION ALL SELECT 'QUERY_SOAP_SUCC_COUNT', 1200, 'Number of successful SOAP queries', NULL
    UNION ALL SELECT 'SOAP_NOTIFY_ESIM_TRANSFER_FAIL_COUNT', 225, 'Number of failed eSIM transfer notifications via SOAP', NULL
    UNION ALL SELECT 'SOAP_NOTIFY_ESIM_TRANSFER_SUCC_COUNT', 900, 'Number of successful eSIM transfer notifications via SOAP', NULL
