...
CROSS JOIN (
    ...
    UNION ALL SELECT 'APNS_PUSH_FAIL_COUNT', 50, 'IOS APNS push failed count', NULL
    UNION ALL SELECT 'ESIM_CLIENT_CONFIRM_ORDER_REQ_SUCC_COUNT', 350, 'Number of successful ESIMCLIENT ConfirmOrder requests', NULL
    UNION ALL SELECT 'ESIM_CLIENT_DOWNLOAD_ORDER_REQ_FAIL_COUNT', 75, 'Number of failed ESIMCLIENT DownloadOrder requests', NULL
    UNION ALL SELECT 'FCM_PUSH_FAIL_COUNT', 50, 'Android FCM push failed count', NULL
    UNION ALL SELECT 'QUERY_COMPANIONESIM_SUBSCRIPTION_FAIL_COUNT', 75, 'Number of failed companion eSIM subscription queries', NULL
    UNION ALL SELECT 'QUERY_COMPANIONESIM_SUBSCRIPTION_SUCC_COUNT', 300, 'Number of successful companion eSIM subscription queries', NULL
    UNION ALL SELECT 'QUERY_SOAP_FAIL_COUNT', 100, 'Number of failed SOAP queries', NULL
    UNION ALL SELECT 'QUERY_SOAP_SUCC_COUNT', 400, 'Number of successful SOAP queries', NULL
    UNION ALL SELECT 'SOAP_NOTIFY_ESIM_TRANSFER_FAIL_COUNT', 75, 'Number of failed eSIM transfer notifications via SOAP', NULL
    UNION ALL SELECT 'SOAP_NOTIFY_ESIM_TRANSFER_SUCC_COUNT', 300, 'Number of successful eSIM transfer notifications via SOAP', NULL
